...
>
> **Pendientes de Florencio:** (a) solicitar indexación de `/jardines-del-sur-7` en Search Console (sin eso Google tarda semanas en recoger las fotos); (b) subir las 9 fotos al perfil de GBP de JdS7; (c) decidir el CP (77500 vs 77536); (d) ⏰ **el crédito de $7,000 de Google vence el 30 jul** — verificar progreso ya.
...
>
> **Pendientes de la sesión:** (a) **horario** — bajar la vista Programación de anuncios → Día y hora ANTES de recortar madrugada ([[project_lead_nighttime_conversion]]: leads de 11pm-12am SÍ cierran); (b) **stats del recurso de mensaje WhatsApp**; (c) migrar las ~85 negativas viejas de nivel grupo → campaña (5-10 min); (d) investigar `altahomescancun.com`; (e) recordatorio crédito $7,000: verificar progreso ~23 jul (vence 30 jul).
