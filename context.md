...
>
> **PENDIENTES:**
> - **(a) PUBLICAR/INDEXAR la página** (paso "enganches"): quitar el `robots: index:false` de `jardines-del-sur-6/casas/page.tsx` → agregar al `sitemap.ts` → enlace discreto desde el silo de JdS6 (+ botones a hermanas). Es lo único que falta para el 2×1 SEO. Puede hacerse YA, en paralelo al pulido del brochure.
> - **(b) MEJORAR EL BROCHURE (pedido de Florencio 25 jul):** "un brochure NO es hoja tamaño carta". Buscar formato de folleto real — apaisado/landscape, tamaño revista, o tríptico. El diseño actual (carta vertical, 6 pág) quedó bien pero él quiere que se sienta más folleto. Seguir trabajando en el PDF.
