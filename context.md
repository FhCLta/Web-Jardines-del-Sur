...
>
> **⏳ PENDIENTE post-migración (NO urgente, funcionan vía redirect mientras tanto). ORDEN DE PRIORIDAD que fijó Florencio (20 jun): ✅ Google Ads HECHO → (PRÓXIMO) GBP ×3 + #1 títulos SEO → (#2, más adelante) acortar rutas de silos "para que se vea fino".**
