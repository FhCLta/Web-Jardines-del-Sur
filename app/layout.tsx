      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var ua=navigator.userAgent||"";if(!/FBAN|FBAV|FB_IAB|Instagram/i.test(ua))return;var d=document.documentElement;d.classList.add("meta-inapp");var p=document.createElement("div");p.style.cssText="font:-apple-system-body;position:absolute;visibility:hidden";d.appendChild(p);var s=parseFloat(getComputedStyle(p).fontSize);d.removeChild(p);if(s>17.5){d.style.fontSize=(17/s*85).toFixed(1)+"%";}}catch(e){}})();`,
          }}
        />
